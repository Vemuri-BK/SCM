# === Updated producer.py with Message Framing and Env Var Integration ===
import socket
...
# Read from environment variables, with defaults for clarity
SERVER = os.getenv('HOST', 'socket')
PORT = int(os.getenv('PORT', 5050))
ADDR = (SERVER, PORT)
KAFKA_BROKER = os.getenv('bootstrap_servers', 'kafka:9092')
KAFKA_TOPIC = os.getenv('topic_name', 'sensor-data') # Make sure this matches the consumer
